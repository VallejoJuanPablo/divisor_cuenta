...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form method="post" action="{{route('procesar_crearreunion')}}" id="form">
                @csrf  
                ...
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <div>
                            <input type="text" class="form-control" name="motivo" id="motivo" placeholder="" required>
                        </div>
                    </div>
                </div>  
                <div class="row ">
                    <div class="col-12 text-center">
                        ...
                        <button id="btn_aceptar" class="btn btn-primary">CREAR REUNION</button>
                        <button type="submit" id="btn_aceptar_real" class=" d-none btn btn-primary">CREAR REUNION</button>
                    </div>
                </div>
            </form>
        </div>
